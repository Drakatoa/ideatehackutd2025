...
<head>
  ...
  <title>Ideate Product Export - ${new Date().toLocaleDateString()}</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p><strong>Generated by Ideate</strong> - AI-Powered Product Ideation Platform</p>
  ...
  ` : ''}
    ...
    a.href = url
    a.download = `Ideate-Product-Export-${new Date().toISOString().split('T')[0]}.html`
